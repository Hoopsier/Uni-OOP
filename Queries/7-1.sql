...
GRANT SELECT, INSERT, UPDATE, DELETE ON conversion.* TO 'appuser'@'localhost';
...
select currency as Most_Pricy from currencies where exchange_rate = (select min(exchange_rate) from currencies);
